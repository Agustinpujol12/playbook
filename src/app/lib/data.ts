...
export const maps: MapInfo[] = [
  {
    ...
    name: "Dust 2",
    colorHex: "#F8D479",
    imageUrl: "/maps/dust2.webp",
    imageHint: "desert map",
  },
  {
    id: "inferno",
    name: "Inferno",
    colorHex: "#4A90E2",
    imageUrl: "/maps/inferno.jpeg",
    imageHint: "italian village map",
  },
  {
    id: "mirage",
    name: "Mirage",
    colorHex: "#9013FE",
    imageUrl: "/maps/mirage.webp",
    imageHint: "north african city map",
  },
  {
    id: "ancient",
    name: "Ancient",
    colorHex: "#1B5E20",
    imageUrl: "/maps/ancient.jpeg",
    imageHint: "jungle ruins map",
  },
  {
    id: "train",
    name: "Train",
    colorHex: "#7ED321",
    imageUrl: "/maps/train.webp",
    imageHint: "rail yard map",
  },
  {
    id: "overpass",
    name: "Overpass",
    colorHex: "#F5A623",
    imageUrl: "/maps/overpass.webp",
    imageHint: "urban park map",
  },
  {
    id: "nuke",
    name: "Nuke",
    colorHex: "#D0021B",
    imageUrl: "/maps/nuke.jpeg",
    imageHint: "nuclear facility map",
  }
];
